<template>
  <!-- component -->
  <div
    class="fixed bottom-0 left-0 z-50 w-full h-16 bg-slate-200 border-t border-gray-200 rounded-full"
  >
    <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
      <button
        type="button"
        :class="'inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-400 group rounded-full'"
      >
        <svg
